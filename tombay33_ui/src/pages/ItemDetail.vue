              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Start Price</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Current Bid</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CurrentBid" type="text" placeholder="Enter CurrentBid" v-model="itemDetails.currentBid"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Auction End Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="itemDetails.auctionEndDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
